...
class SplashScreenActivityTest {
    ...
    fun test_isActivityInView_isViewsDisplayed_isViewsVisible() {
        ...
        onView(withId(R.id.cvLogoImageView)).check(matches(isDisplayed()))
        onView(withId(R.id.ironManLottieView)).check(matches(isDisplayed()))

        onView(withId(R.id.cvLogoImageView)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
